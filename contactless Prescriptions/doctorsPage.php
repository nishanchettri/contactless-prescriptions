            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title" align="center"style="margin-left: -250px;margin-bottom: 50px;"> <b>PRESCRIBE</b></h4>
                    </div>
                </div>
                <div class="row"style="margin-left: -250px;">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="send_email_html.php" method="GET">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="med" required>
                                    </div>
                                </div>
